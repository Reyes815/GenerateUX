...
var IframeResizer = function IframeResizer(props) {
  ...
  var onClose = function onClose() {
    ...
    warning_1(!(iframeRef != null && iframeRef.current), "[iframeSizerReact][" + (iframeRef == null || (_iframeRef$current = iframeRef.current) == null ? void 0 : _iframeRef$current.id) + "] Close event ignored, to remove the iframe update your React component");
